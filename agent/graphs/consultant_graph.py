...
class ConsultantGraph:
    ...
    def invoke(self, query: str, activity_name: str, category_name: str):
        ...
        answer = self.graph.invoke(
            ...
            "similary_name": self.similary_name,
            "hallucination": self.hallucination}
        )
        self.history = answer["history"]
        self.activity_name = answer["activity_name"]
        self.category_name = answer["category_name"]
        self.similary_name = answer["similary_name"]
    ...
    def chat(self, content):
        ...
        while True:
            ...
            self.invoke(content, activity_name=activity_name, category_name=category_name)
